...
cartRouter.route('/getCartList').get([],(req, res) => {
...
cartRouter.route('/getCartById/:id').get([],(req, res) => {
    const data = {
        _id: req.params.id
    };
...
cartRouter.route('/deleteCart/:id').delete([],(req, res) => {
    const data = {
        _id: req.params.id
    };
...
cartRouter.route('/getCartByEmployeeId/:id').get([],(req, res) => {
    // const data = {
