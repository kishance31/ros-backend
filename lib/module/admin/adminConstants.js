...
const MESSAGES = {
  ...
  Corporate_Status:"Corporate Status Updated",
  ...
  changePasswordSuccess: "Password change successfull.",
...
const MAIL_MESSAGE = {
  ...
  STATUS_CHANGED_APPROVED:"Your account has been approved",
  STATUS_CHANGED_REJECTED:"Your account has been rejected",
  STATUS_SUB:"Account Status"
}
module.exports = {
  MESSAGES: MESSAGES,
  CODE: CODE,
