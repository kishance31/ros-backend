const MESSAGES = {
  ...
  CmsFacebookCantEmpty: 'Facebook is required',
  CmsInstagramCantEmpty: 'Instagram is required',
  CmsPinterestCantEmpty: "Pinterest is required",
  CmsGoogleCantEmpty: "Google is required",
  CmsTwitterCantEmpty: "Twitter is required",
};
const CODE = {
  FRBDN: 403,
  INTRNLSRVR: 500,
