...
function socialMediaLinks(data) {
    return cmsService.socialMediaLinks(data).then(result => result)
}

function getSocialMediaLinks(...args) {
    return cmsService.getSocialMediaLinks(...args).then(result => result)
}
