...
licenseRouter.get('/licenseList', [authMiddleware.autntctAdminTkn], (req, res) => {
...
//get all license list
licenseRouter.get('/corporateLicenseList', [authMiddleware.autntctTkn], (req, res) => {
    licenseFacade.corporateLicenseList()
        .then(result =>
            responseHandler.sendSuccess(res, result)
        )
        .catch(err => {
