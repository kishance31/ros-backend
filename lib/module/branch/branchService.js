...
function branchList() {
    try {
        return branchDao.branchList().then((data) => {
            return branchMapper.responseMappingData(branchConstants.CODE.branchList, branchConstants.MESSAGES.Success, data)
...
function getBranchById(id) {
    try {
        return branchDao.branchById(id).then((data) => {
            return branchMapper.responseMappingData(branchConstants.CODE.Success, branchConstants.MESSAGES.branchById, data)
