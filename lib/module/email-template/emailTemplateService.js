...
function emailTemplateList() {
    try {
        return emailTemplateDao.emailTemplateList().then((data) => {
            return emailTemplateMapper.responseMappingData(emailTemplateConstants.CODE.Success, emailTemplateConstants.MESSAGES.EmailTemplate_Listed, data)
