...
exports.getPurchaseLicenseList = async (corporateId) => {
    return await purchasedLicenseDao.find(
        { corporateId },
        { _id: 0, __v: 0, updatedAt: 0, "purchasedLicenses._id": 0, "purchasedLicenses.licenseId": 0 }
    );
}