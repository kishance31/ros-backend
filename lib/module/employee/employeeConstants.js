const MESSAGES = {
    ...
    orderListError: 'Error getting orders list.',
    orderCancelError: "Cannot cancel order.",
    orderListSuccess: "Order List success.",
    deactiveEmployeeError: "Deactivate employee error",
    deactiveEmployeeSuccess: "Deactivate employee success",
