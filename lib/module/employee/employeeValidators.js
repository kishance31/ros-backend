...
const validateUser = (req, res, next) => {
    ...
    const loginDetails = { email, fullName } = req.body;
    ...
    if (!fullName) {
        errors.push({ code: employeeConstants.CODE.Unauthorized, message: employeeConstants.MESSAGES.EmployeeNameCantEmpty });
    }
...
const validateOrder = (req, res, next) => {
    ...
    const { corporateId, employeeId, products, address } = req.body;
    ...
    req.orderDetails = { corporateId, employeeId, products, address };
    next();
}
