module.exports = {
    ...
    protocol: 'https',
    TAG: "production",
    clientUrl: "https://remoteofficessolution.com",
    adminUrl: "https://admin.remoteofficessolution.com",
    mongo: {
        dbName: 'ros_db',
        dbUrl: "mongodb://ros:42yHLPvv@localhost:27017/ros_db",
        options: {
    ...
    FROM_EMAIL: "remoteofficessolutions@gmail.com",
    RESET_CLIENT_URL: "https://admin.remoteofficessolution.com/auth/reset-password",
    ADMIN_MAIL_ID: "remoteofficessolutions@gmail.com",
    RESET_PSWD_CORPORATE_URL: "https://remoteofficessolution.com",
